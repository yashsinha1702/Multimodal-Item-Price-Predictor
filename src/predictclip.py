...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type=str,default="/home/abrol/khushal/Misc/Amazon_Challenge/Yash_EXp/student_resource/src/clip_checkpoints/clip_price_predictor_epoch_4.pth",  help='Path to the fine-tuned price predictor head (.pth file).')
    ...
    parser.add_argument('--image_dir', type=str, default="/home/abrol/khushal/Misc/Amazon_Challenge/Yash_EXp/student_resource/images", help='Path to the directory containing product images.')
    parser.add_argument('--output_csv', type=str, default='clip_predictions.csv', help='Path to save the output predictions CSV file.')
    parser.add_argument('--model_name', type=str, default='openai/clip-vit-base-patch16', help='Name of the pre-trained CLIP model.')
    parser.add_argument('--device', type=str, default="cuda:3" if torch.cuda.is_available() else "cpu", help='Device to run inference on (e.g., "cuda:0" or "cpu").')
