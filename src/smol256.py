...
# --- 1. Configuration ---
CONFIG = {
    "csv_file_path": "/home/gpu2/warade/student_resource/dataset/train.csv",
    "image_directory": "/home/gpu2/warade/student_resource/images",
...
class PricePredictionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            image = transform(Image.open(item['image_path']).convert('RGB'))
...
def train_model(config):
    ...
    train_loader = DataLoader(
        ...
        collate_fn=collator, num_workers=config['num_workers'],persistent_workers=True
    )
